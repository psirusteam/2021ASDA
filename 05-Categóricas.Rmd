...
|-------------------|-------------|---------------|--------------|
|                   | 0           | 1             |              |
| 0                 | $n\_{00}$    |   $n\_{01}$    | $n\_{0+}$     |
| 1                 | $n\_{10}$    |   $n\_{11}$    | $n\_{1+}$     |
| Marginal columna  | $n\_{+0}$    |   $n\_{+1}$    | $n\_{++}$     |
...
|-------------------|-------------|---------------|--------------|
|                   | 0           | 1             |              |
| 0                 | $\hat{N}*{00}$| $\hat{N}*{01}$| $\hat{N}*{0+}$|
| 1                 | $\hat{N}*{10}$| $\hat{N}*{11}$| $\hat{N}*{1+}$|
| Marginal columna  | $\hat{N}*{+0}$| $\hat{N}*{+1}$| $\hat{N}\_{++}$|
